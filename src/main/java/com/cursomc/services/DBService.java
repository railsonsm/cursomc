...
public class DBService {
	...
	public void instantiateTesteDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "05763252527", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("71982576778", "7133919350"));
		
		Cliente cli2 = new Cliente(null, "Railson Silva", "maria1@gmail.com", "05763252527", TipoCliente.PESSOAJURIDICA);
		...
		Pedido ped1 = new Pedido(null, sds.parse("30/09/2018 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sds.parse("31/10/2018 10:32"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE,
				ped2, sds.parse("20/10/2017 00:00"), null);
